<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListerOrdi.aspx.cs" Inherits="GestionRessources.ListerOrdi" %>
...
<body style="background:url(../images/ll.jpg) no-repeat; background-size : cover ;">
				...
				<div class="container" id="editableTable">
					...
					<div class="row">
                        <div class="col-md-12">
                        	...
                        	<br />	<br />	<br />
						<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="White" BorderStyle="Ridge" BorderWidth="2px" CellPadding="3" CellSpacing="1" DataKeyNames="Id" DataSourceID="SqlDataSource1" GridLines="None" Height="100px" Width="1000px">
                            <Columns>
                                ...
                                <asp:BoundField DataField="disquedur" HeaderText="disquedur" SortExpression="disquedur" />
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" DeleteCommand="DELETE FROM [ordinateur] WHERE [Id] = @Id" InsertCommand="INSERT INTO [ordinateur] ([cpu], [ecran], [marque], [disquedur], [ram], [idfournis]) VALUES (@cpu, @ecran, @marque, @disquedur, @ram, @idfournis)" SelectCommand="SELECT * FROM [ordinateur]" UpdateCommand="UPDATE [ordinateur] SET [cpu] = @cpu, [ecran] = @ecran, [marque] = @marque, [disquedur] = @disquedur, [ram] = @ram, [idfournis] = @idfournis WHERE [Id] = @Id">
                            <DeleteParameters>
                            ...
                            <InsertParameters>
                                ...
                                <asp:Parameter Name="disquedur" Type="String" />
