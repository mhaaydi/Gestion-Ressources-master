...
{
    public partial class AjouterImp : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            conn.Open();
            String req = "insert into Impri values('" + TextBox1.Text + "','" + TextBox2.Text + "'," + TextBox3.Text +","+GridView1.SelectedRow.Cells[1].Text +")";
