<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="listUtilisateur.aspx.cs" Inherits="GestionRessources.listUtilisateur" %>
     ...
     <nav id="mainNav" style="background-color: #570880;">
      <ul>
        <li><a href="ChefDepartement.aspx"><i class="icon-home"></i><img src="../images/homei.png" /><br />Acceuil</a></li>
          ...
          <li><a href="#"><i class="icon-print"></i><img src="../images/listefour.png" /><br />Gérer les utilisateurs</a>
     <ul class="sub-menu">
    ...
    <div style=" height: 100%; width: 100%;">
				<div class="container" id="editableTable">
					...
					<div class="row">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" DeleteCommand="DELETE FROM [utilisateur] WHERE [Id] = @Id" InsertCommand="INSERT INTO [utilisateur] ([Login], [password]) VALUES (@Login, @password)" SelectCommand="SELECT * FROM [utilisateur]" UpdateCommand="UPDATE [utilisateur] SET [Login] = @Login, [password] = @password WHERE [Id] = @Id">
                            <DeleteParameters>
